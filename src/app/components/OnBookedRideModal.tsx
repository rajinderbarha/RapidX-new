...
const OnBookedRideModal: React.FC<BottomModalProps> = ({ onChange, isFocused }) => {
    ...
    <View style={styles.container}>
        ...
        <View style={styles.driverDetails}>
          ...
          <View style={styles.rating}>
            {[...Array(driver.rating)].map((_, i) => (
              <Icon key={i} name="star" type="font-awesome" color="#FFD700" size={20} style={{marginHorizontal : 3}} />
            ))}
          </View>
        </View>
      ...
      <View style={styles.vehicleInfo}>
        ...
        <View style={styles.vehicleDetails}>
          <Text style={styles.arrivalTime}>Your Ride is Arriving in {driver.arrivalTime}</Text>
      ...
      <View style={styles.footer}>
        ...
        <OrangeButton text={'Cancel Ride'} onPress={onCancelRide}  />
      </View>
    </View>
    </CustomBottomModal>
  );
